...
import KimiHome from "./features/storefront/kimi/pages/Home";
...
// Kimi home ships its own Navbar + Footer, so it renders outside StorefrontLayout.
function KimiHomePage() {
  return (
    <>
      <KimiHome />
      <AssistantWidget />
...
export default function App() {
  return (
    <Routes>
      <Route path="/" element={<KimiHomePage />} />
