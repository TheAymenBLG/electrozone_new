...
function StatCard({ title, value, icon: Icon, hint, change }: { title: string; value: string; icon: typeof Wallet; hint: string; change: string }) {
  return (
    <div className="bg-navy-card border border-edge rounded-2xl p-6 glow-hover card-lift">
  ...
  return (
    <div className="max-w-6xl">
      <header className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-8">
        <div>
          <h1 className="font-head text-3xl font-bold text-gradient">Aperçu</h1>
      ...
      <div className="bg-navy-card border border-edge rounded-2xl p-6 mb-6 card-lift">
      ...
      <div className="bg-navy-card border border-edge rounded-2xl p-6 card-lift">
